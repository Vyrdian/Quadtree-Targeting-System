...
2) Use the editor window to set the center, radius, and Coordinate Pair so that it covers the entire area you need, Its okay if it extends further out.
...
2)If it starts in the scene, set the reference to QTTSQuadtree in the editor, otherwise inject the data with the SetQuadTree method
3)If the position of the target changes, update it with the OnPositionChanged method
